#!/usr/bin/env python3
# Sends an IEC 61850 GOOSE trip frame (EtherType 0x88B8) and waits for
# the asset's unicast echo reply. The Industroyer module used this
# protocol to trip Ukrainian substation breakers in 2016.
